<?php
namespace toolbox;
class update_contact_info_controller {
        ...
        <div class="form_panel" id="email_validation_panel">
            ...
            <table class="steps">
                ...
                form::textField()
                        ...
                        ->setName('first_name')
                        ->setLabel(false)
                        ->setValue(user::getUserLoggedIn()->getCustomValue('first_name'))
                ...
                form::textField()
                        ...
                        ->setName('last_name')
                        ->setLabel(false)
                        ->setValue(user::getUserLoggedIn()->getCustomValue('last_name'))
                ...
                form::textField()
                        ...
                        ->setName('address')
                        ->setLabel(false)
                        ->setValue(user::getUserLoggedIn()->getCustomValue('address'))
                ...
                form::textField()
                        ...
                        ->setName('country')
                        ->setLabel(false)
                        ->setValue(user::getUserLoggedIn()->getCustomValue('country'))
                ...
                form::textField()
                        ...
                        ->setName('region')
                        ->setLabel(false)
                        ->setValue(user::getUserLoggedIn()->getCustomValue('region'))
                ...
                form::textField()
                        ...
                        ->setName('city')
                        ->setLabel(false)
                        ->setValue(user::getUserLoggedIn()->getCustomValue('city'))
                        ->setPlaceholder('City:')
                        ->render();
                        ?>
                        </td>
                ...
                form::textField()
                        ...
                        ->setName('postal_code')
                        ->setLabel(false)
                        ->setValue(user::getUserLoggedIn()->getCustomValue('postal_code'))
